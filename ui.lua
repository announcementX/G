...
function Library:CreateWindow(title)
    ...
    ScreenGui.Name = "PinkPerfect_v4"
    ScreenGui.Parent = game.CoreGui
    ScreenGui.ResetOnSpawn = false

    local MainFrame = Instance.new("Frame")
    MainFrame.Size = UDim2.new(0, 500, 0, 340) -- 稍微放大一点点
    ...
    CreateFancyBtn(UDim2.new(1, -82, 0.5, -16), false, function()
        min = not min
        TweenService:Create(MainFrame, TweenInfo.new(0.4, Enum.EasingStyle.Quart), {Size = min and UDim2.new(0, 500, 0, 50) or UDim2.new(0, 500, 0, 340)}):Play()
    end)

    -- --- 侧边栏 (修复间距) ---
    local SideBar = Instance.new("Frame")
    SideBar.Size = UDim2.new(0, 130, 1, -50); SideBar.Position = UDim2.new(0, 0, 0, 50)
    SideBar.BackgroundColor3 = Colors.SideBarBg; SideBar.Parent = MainFrame
    ...
    TabList.Padding = UDim.new(0, 10) -- 【修复】增加按钮之间的间距
